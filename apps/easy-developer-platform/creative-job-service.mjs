...
http.createServer(async (req,res)=>{
  ...
  try {
    if (req.method === 'GET' && u.pathname === '/api/creative-job/health') return send(res,200,{ok:true,service:'easy-creative-orchestrator',version:'0.1.0'});
    ...
    const provider = mode === 'fixture' ? fixtureProvider() : null;
