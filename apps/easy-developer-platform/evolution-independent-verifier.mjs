...
function validateCheckCommand(t){if(!t||typeof t.cmd!=='string'||!['git',process.execPath,'node'].includes(t.cmd))throw new Error('untrusted_test_command');if(t.args!==undefined&&!Array.isArray(t.args))throw new Error('invalid_test_args');if(t.args?.some(arg=>typeof arg!=='string'))throw new Error('invalid_test_arg');if(t.timeout!==undefined&&(!Number.isInteger(t.timeout)||t.timeout<1||t.timeout>120000))throw new Error('invalid_test_timeout')}
